    ...
    public class TCCorsPolicyProvider : Attribute, ICorsPolicyProvider
    {
        ...
        void LogRequest()
        {
            try
            {
                ...
                {
                    if (HttpContext.Current.User.Identity.Name == "lamktvn@gmail.com" || HttpContext.Current.User.Identity.Name == "0949777782" || HttpContext.Current.User.Identity.Name == "anhnlnps07618@fpt.edu.vn") return;
