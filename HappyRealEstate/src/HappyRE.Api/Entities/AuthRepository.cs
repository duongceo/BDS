    ...
    public class AuthRepository : IDisposable
    {
        ...
        public async Task<IdentityUser> FindUser(string userName, string password)
        {
            ...
            if (user == null)
            {
                ...
                if (k == null) k = FindUserByMobile(userName);
        ...
        public async Task<IdentityUser> FindUser(string userName)
        {
            ...
            if (user == null) user = FindUserByMobile(userName);
            return user;
        }

        public IdentityUser FindUserByMobile(string mobile)
        {
        ...
        public RefreshToken FindRefreshTokenByName(string name)
        {
        ...
        public async Task<IdentityUser> FindByNameAsync(string userName)
        {
            ...
            if (user == null) user = string.IsNullOrEmpty(userName) == true ? null : FindUserByMobile(userName);
            return user;
        }
