mogiApp.controller('industrialParkController', ['$scope',
    function ($scope) {
        $scope.Query = {
            keyword: '',
            cid: 0,
        ...
        $scope.Cities = (function () {
            ...
            var bd = mogiCities.hash["c9"];
            var data = [all_loc, hcm, hn, bd];
        ...
        $scope.Place = (function () {
            ...
            return {
                ...
                GetData: function () {
                    ...
                    endIndex = endIndex < $scope.Place.Items.length ? endIndex : $scope.Place.Items.length;
                    return $scope.Place.Items.slice(startIndex, endIndex);
                },
                ...
                Filter: function () {
                    ...
                    if ($scope.Query.keyword !== void (0) && $scope.Query.keyword !== null && $scope.Query.keyword != '') {
                        ...
                        data = _.filter(data, function (Place) {
                            return regex.test(Place.n);
                            //return Place.n.toUpperCase().indexOf($scope.Query.keyword.toUpperCase()) >= 0;
                        });
                    }

                    $scope.Place.Items = data;
                }
            };
        }());
