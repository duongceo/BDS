...
using log4net;
using HappyRE.EmailServices.Offline;
    ...
    public class GmailPersonalSvc
    {
        ...
        public ApiResponse Auth()
        {
            ...
            if (string.IsNullOrEmpty(_user))
            {
                ...
                res.Message = HappyRE.Core.Entities.Resources.Messages.Gmail_Expired;
                return res;
            }
            ...
            try
            {
                ...
                if (credential.Token != null && credential.Token.AccessToken.Length > 0)
                {
                    ...
                    if (res.Data.ToString() != _tokenJson && fileToken.HasRefreshToken(res.Data.ToString()))
                    {
                        res.Message = "Updated";
                        //Update token
                        fileToken.SaveToken(res.Data.ToString());
                    }
                }
            }
            catch (Exception ex)
