...
namespace HappyRE.Core.BLL.Repositories
{
    public abstract class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        private HappyREDataContext _l2qContext = null;
        public HappyREDataContext L2qContext
        {
            get
            {
                if (_l2qContext == null) _l2qContext = new HappyREDataContext(this.GetConnectionString()) { ObjectTrackingEnabled = false };
                return _l2qContext;
            }
        }
        ...
        public BaseRepository(IUow uow)
        {
            ...
            _tableName = "HappyRE_" + typeof(T).Name;
        }
        ...
        #endregion
        public virtual void LogUserActivity(string userId, string key, string content, string action="add")
        {
        }
        #region Log
        #endregion
        ...
        internal bool isSharing(Guid id)
        {
            return _uow.Token.IsSharing(id);
        }
        #endregion
