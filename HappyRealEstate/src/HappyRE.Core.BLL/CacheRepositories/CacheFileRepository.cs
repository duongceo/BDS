...
namespace HappyRE.Core.BLL.Repositories
{
    ...
    {
        internal readonly static CacheHashtable HID = new CacheHashtable(HappyRE.Core.Entities.Conts.CACHE_HASHTABLE_FILE);
        ...
        public override void RemoveCache(Guid id)
        {
            ...
            // get all
            cacheId = this.GetCacheKey(HappyRE.Core.Entities.Conts.CACHE_KEY_ALL);
