...
using HappyRE.Core.Entities.Integration.Twilio;
using System;
...
namespace HappyRE.IntegrationService.TwilioSms
{
    public class TwilioService
    {
        private static readonly ILog _log = LogManager.GetLogger("TwilioService");
